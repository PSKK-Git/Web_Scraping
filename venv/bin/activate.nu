...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/saikrishnakarthikp/IdeaProjects/web_scraping_python_jobs/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/saikrishnakarthikp/IdeaProjects/web_scraping_python_jobs/venv/bin/deactivate.nu'
